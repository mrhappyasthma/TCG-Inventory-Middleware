...
- **Module B (Upstream Batches)**: Automatically ingests SortSwift batches, assigns manifest IDs, and routes cards into `ebay_inventory_updates.csv` (Revise) or `ebay_new_additions.csv` (Add).
